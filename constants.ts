...
export const ASIGNATURAS_POR_ETAPA: Record<string, { value: string; label: string }[]> = {
    ...
    primaria: [
      { value: 'ciencias-naturaleza', label: 'Ciencias de la Naturaleza' },
      { value: 'ciencias-sociales', label: 'Ciencias Sociales' },
      { value: 'valores-civicos-eticos', label: 'Educación en Valores Cívicos y Éticos' },
      { value: 'educacion-fisica', label: 'Educación Física' },
      { value: 'educacion-plastica-visual', label: 'Educación Plástica y Visual' },
      { value: 'lengua-castellana-literatura', label: 'Lengua Castellana y Literatura' },
      { value: 'lengua-extranjera', label: 'Lengua Extranjera' },
      { value: 'matematicas', label: 'Matemáticas' },
      { value: 'musica-danza', label: 'Música y Danza' },
      { value: 'profundizacion-educativa', label: 'Profundización Educativa' },
      { value: 'religion-atencion-educativa', label: 'Religión / Atención Educativa' },
      { value: 'segunda-lengua-extranjera', label: 'Segunda Lengua Extranjera' },
    ],
    secundaria: [
